...
public class GpsSkyFragment extends Fragment implements GpsTestActivity.OrientationChangeListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSkyView = new GpsSkyView(activity);
    ...
    private static class GpsSkyView extends View implements GpsTestActivity.OrientationChangeListener {
        ...
        public void setSats(USBGpsSatellite[] satellites) {
            ...
            for (USBGpsSatellite satellite: satellites) {
                mSnrCn0s[mSvCount] = satellite.snr; // Store SNR values (see #65)
                mElevs[mSvCount] = satellite.elevation;
                mAzims[mSvCount] = satellite.azimuth;
                mPrns[mSvCount] = satellite.prn;
        ...
        private void drawSatellite(Canvas c, int s, float elev, float azim, float snrCn0, int prn,
            ...
            if (prn == -1) {
                ...
                prnString = String.valueOf(prn);
            }

            c.drawText(prnString, x - (int) (SAT_RADIUS * PRN_X_SCALE),
