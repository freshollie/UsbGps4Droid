...
public class GpsMapFragment extends SupportMapFragment
        implements GpsTestActivity.OrientationChangeListener,
        USBGpsApplication.UsbGpsDataListener,
        View.OnClickListener, LocationSource,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        application = (USBGpsApplication) activity.getApplication();
        return v;
    }
    ...
    @Override
    public void onLocationNotified(Location loc) {
