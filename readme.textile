*UsbGPS4Cupcake alpha5* (2012-08-26)
* UsbGps4Droid version adapted for Cupcake and Donuts - *Do not use with Eclair, Froyo or Gingerbread !!!*
* Based on BlueGps4Cupcake version 1.2.2 and UsbGPS4Droid version alpha5.
...
* Disable SIRF options in settings since they are not working (actually) in UsbGPS

UsbGPS4Cupcake alpha4 (2012-03-24)
* UsbGps4Droid version adapted for Cupcake and Donuts - *Do not use with Eclair, Froyo or Gingerbread !!!*
* Based on BlueGps4Cupcake version 1.2.2 and UsbGPS4Droid version alpha4.

UsbGPS4Droid alpha4 (2012-03-24)
...
UsbGPS4Cupcake alpha1 (2012-03-07)
* UsbGps4Droid version adapted for Cupcake and Donuts - *Do not use with Eclair, Froyo or Gingerbread !!!*
* Based on BlueGps4Cupcake version 1.2.2 and UsbGPS4Droid version alpha3.
...
"BlueGps4Cupcake 1.2.2":http://sourceforge.net/projects/bluegps4droid/files/Apk/BlueGPS4Droid_1.2.x/BlueGps4Cupcake_1.2.2.apk/download (2011-05-24)
